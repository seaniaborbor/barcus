...
<div class="bg-light rounded h-100 p-4">
   <form action="<?=base_url('dashboard/menu/')?>" method="post" enctype="multipart/form-data">
   <h6 class="mb-4">Add New Menu</h6>
    <div class="form-floating mb-3">
        <input type="text"  name="menuName" value="<?= set_value('menuName')?>" class="form-control" id="floatingInput"
